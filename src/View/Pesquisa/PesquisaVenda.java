...
public class PesquisaVenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabVendas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID da Venda", "ID Produto", "Nome Produto", "Descrição", "Preço Unitário", "Quantidade", "Preço Total Item"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 910, -1));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        String [] colunas = new String[]{"ID da Venda","ID Produto ","Nome Produto", "Descrição","Preço unitário","Quantidade","Preço Total por Item" }; 
       // controlVenda.atualizaTabela(tabVendas, colunas);
        try {
            tabVendas = controlVenda.dadostabela(tabVendas, controlVenda.impressaoTabela(nomebusca), colunas);
