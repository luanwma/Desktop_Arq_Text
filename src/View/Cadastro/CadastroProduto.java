...
public class CadastroProduto extends javax.swing.JFrame {
    ...
    public CadastroProduto(boolean confg, int id){
        initComponents();
        this.id = id;
        confBotoes(confg);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try{
            ...
            if(controle.gravarOrdenado(id , nome, pnum, descricao) == true){
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        double pnum = Double.parseDouble(preco);
        try{
            int id = controle.novoId();
            if(controle.criarProduto(id , nome, pnum, descricao) == true){
